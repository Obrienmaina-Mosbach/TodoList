      ...
      <section>
        ...
        <ul class="space-y-4">
          ...
          <TodoItem
            ...
            @update-todo="updateTodoDetails" <!-- New event listener -->
          />
        </ul>
      </section>
    </div>
...
const todos = ref([
  { id: 1, taskName: 'Learn Vue 3 Basics', taskDescription: 'Understand components, props, and events.', status: 'pending', dueDate: null, completedAt: null },
  { id: 2, taskName: 'Build a To-Do App', taskDescription: 'Apply learned concepts to a practical project.', status: 'completed', dueDate: new Date('2025-07-20T10:00').toISOString().slice(0, 16), completedAt: new Date('2025-07-17T14:00:00Z').toISOString() },
  { id: 3, taskName: 'Explore Vue Router', taskDescription: 'Learn how to navigate between different views.', status: 'pending', dueDate: new Date('2025-07-25T14:30').toISOString().slice(0, 16), completedAt: null }
]);
...
const addTodo = () => {
  ...
  const newTodo = {
    ...
    completedAt: null // Initialize completedAt as null for new tasks
  };
